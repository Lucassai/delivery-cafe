...
export function CardProduto({
  ...
  return (
    <>
      <div
        className={
          "bg-white drop-shadow-lg h-full  lg:w-full select-none" +
      ...
      >
        ...
        <div className="fixed flex flex-end items-end justify-evenly w-full h-full group text-center text-lg ">
          ...
          <div
            className={
              "fixed flex flex-col opacity-0 group-hover:animate-fade-up group-active:animate-fade-up   group w-full h-50 bg-orange-300/30 backdrop-blur-md " +
              (item % 2 == 0 ? roundend1 : roundend2)
            }
          >
