...
export const BotaoProdutoCategoria: React.FC<BotaoProdutoCategoriaProps> = ({
  onClick,
}) => {
  return (
    <>
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div
          className="wire-one-regular text-2xl font-bold shadow-2xl flex items-center justify-between peer rounded-br-2xl rounded-tl-2xl outline-none
